...
export const ALL_RETAINERS: RetainerDef[] = [
  ...
  },
  {
    ...
    promotion: {
      type: 'none',
      reason:
        'It disappears in a puff of foul-smelling vapour if its employer croaks',
    },
  },
  {
    id: 'jester',
...
export const TRAIT_MAP = new Map<string, TraitDef>(
  ALL_TRAITS.map((t) => [t.id, t]),
);
export const RETAINER_MAP = new Map<string, RetainerDef>(
  ALL_RETAINERS.map((r) => [r.id, r]),
);
...
export const SITUATIONS: SituationDef[] = [
  ...
  },
  {
    ...
    label: 'Churl',
    description:
      "The common folk: mud-caked, flea-bitten, and absolutely essential to the realm's economy. You possess no titles, though you do possess a certain fragrance. Unburdened by destiny or social graces, you're free to become nearly anything — except invited to dinner.",
  ...
  },
  {
    ...
    label: 'Noble',
    description:
      'Fancy garments, lavish banquets, and swanning about ballrooms with all the right people — how delightful for you. As a titled (and rather entitled) member of the aristocracy, you embody elegance, good breeding, and social cunning. A natural leader, though you have no interest whatsoever in Nature and its many inconveniences. You have fewer options during creation — yes, life is terribly hard — but your posh upbringing makes you considerably harder to kill or drive round the bend.',
    ...
    choices: [
      {
        ...
        options: [
          ...
          { id: 'euterpe', label: 'Euterpe', requiredTraits: ['subtlety'] },
          {
            id: 'melpomene',
            label: 'Melpomene',
            requiredTraits: ['authority'],
          },
          {
            id: 'polyhymnia',
            label: 'Polyhymnia',
            requiredTraits: ['strategy'],
          },
          {
            id: 'terpsichore',
            label: 'Terpsichore',
            requiredTraits: ['nimbleness'],
          },
          { id: 'thalia', label: 'Thalia', requiredTraits: ['glibness'] },
          {
            id: 'urania',
            label: 'Urania',
            requiredTraits: ['wisdom_in_the_ways_of_science'],
          },
        ],
      },
    ],
...
export const SITUATION_MAP = new Map<string, SituationDef>(
...
export function getPickableTraits(
  situationId: string,
